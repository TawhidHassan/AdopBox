                  ...
                  child: ListView(
                    children: [
                      Column(
                        ...
                        children: [
                          Text("Is your pet tame or stray?",
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  child: InkWell(
                                    onTap: () {
                                      postCreateController!.patTypeUpdate(
                                          "tame");
                                    },
                                    child: Container(
                                        ...
                                        children: [
                                          Radio(
                                              ...
                                              groupValue: postCreateController!
                                                  .darftPostModel!.petType ==
                                                  "tame",
                                              onChanged: (onChanged) {
                                                postCreateController!
                                                    .patTypeUpdate("tame");
                                              }),
                                          Text("Tame", style: mediumText(
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  child: InkWell(
                                    onTap: () {
                                      postCreateController!.patGenderUpdate(
                                          1);
                                    },
                                    child: Container(
                                      margin: EdgeInsets.only(top: 13.h),
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Does your pet have any diseases?",
                            style: mediumText(16.sp,),),
                          SizedBox(height: 4.h,),
                          SizedBox(
                            width: 1.0.sw,
                            child: Row(
                              children: [
                                Expanded(
                                  child: InkWell(
                                    onTap: () {
                                      postCreateController!.patDisesesUpdate(
                                          true);
                                    },
                                    child: Container(
                                      margin: EdgeInsets.only(top: 13.h),
                                      ...
                                      child: Row(
                                        children: [
                                          Radio(
                                              value: true,
                                              groupValue: postCreateController!
                                                  .darftPostModel!.dieseas ==
                                                  true,
                                              onChanged: (onChanged) {
                                                postCreateController!
                                                    .patDisesesUpdate(true);
                                              }
                                          ),
                                          Text("Yes", style: mediumText(
                                              16.sp, color: textColor),)
                      ...
                      SizedBox(height: 20.h,),
                      postCreateController!.getCatorgBredCirculler.value
                          ? LoadingWidget()
                          : Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              categorSheet(context,
                                  postCreateController!.categoryList!.value);
                            },
                            child: Container(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment
                                    .spaceBetween,
                                children: [
                                  Text(postCreateController!.selectCategory
                                      .value == ""
                                      ? "Select Category"
                                      : postCreateController!.selectCategory
                                      .value, style: mediumText(
                                      16.sp, color: textColor),),
                            ...
                            child: Container(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment
                                    .spaceBetween,
                                children: [
                                  Text(postCreateController!.selectOrigin
                                      .value == ""
                                      ? "Select Origin"
                                      : postCreateController!.selectOrigin
                                      .value, style: mediumText(
                                      16.sp, color: textColor),),
                                  Icon(Icons.keyboard_arrow_right,)
                                ],
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    postCreateController!.selectBreed.value ==
                                        ""
                                        ? "Select Breed"
                                        : postCreateController!.selectBreed
                                        .value, style: mediumText(
                                      16.sp, color: textColor),),
                                  Icon(Icons.keyboard_arrow_right,)
                                ],
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            "Pet age (Optional)", style: mediumText(16.sp,),),
                          SizedBox(height: 8.h,),
                          InkWell(
                            onTap: () {
                              ageSheet(context);
                            ...
                            child: Container(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment
                                    .spaceBetween,
                                children: [
                                  Text(postCreateController!.darftPostModel!
                                      .age != null ? convertToYearsAndMonths(
                                      postCreateController!.darftPostModel!
                                          .age!.toInt()) : "Select pet age",
                                    style: mediumText(
                                        16.sp, color: textColor),),
                                  Icon(Icons.keyboard_arrow_right,)
                                ],
                      ...
                      children: [
                        ...
                        Expanded(
                          child: CustomButton(
                              ...
                              title: "Next",
                              onTap: () {
                                postCreateController!.controller.jumpToPage(
                                    2);
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  SizedBox(width: 12.w,),
                                  Text("Breeds", style: semiBoldText(
                      ...
                      Expanded(
                        ...
                        child: Padding(
                          ...
                          child: GridView.builder(
                              shrinkWrap: true,
                              itemCount: postCreateController!
                                  .breedList!
                                  .value
                                  .where((element) =>
                              element.origin ==
                                  postCreateController!.selectOriginId.value)
                                  .length,
                              ...
                              itemBuilder: (context, index) {
                                return InkWell(
                                  onTap: () {
                                    postCreateController!.patBreedUpdate(
                                        postCreateController!.breedList!.value
                                            .where((element) =>
                                        element.origin ==
                                            postCreateController!.selectOriginId
                                                .value).toList()[index]);
                                    Navigator.pop(context);
                                  },
                                  child: Column(
                                      ...
                                      Text(
                                        ...
                                        element.origin ==
                                            postCreateController!.selectOriginId
                                                .value).toList()[index]
                                            .breedName!.length > 5
                                            ? postCreateController!.breedList!
                                            .value.where((element) =>
                                        element.origin ==
                                            postCreateController!.selectOriginId
                                                .value).toList()[index]
                                            .breedName!.substring(0, 5) + ".."
                                            : postCreateController!.breedList!
                                            .value.where((element) =>
                                        element.origin ==
                                            postCreateController!.selectOriginId
                                                .value).toList()[index]
                                            .breedName!, style: mediumText(
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  SvgPicture.asset("assets/icons/border.svg"),
                                  SizedBox(width: 12.w,),
                                  Text("Origins", style: semiBoldText(
                                      20.sp, color: appBarTitleTextColor),)
                                ],
                              ),
                            ),
                        ...
                        child: Padding(
                          ...
                          child: GridView.builder(
                              ...
                              itemCount: postCreateController!
                                  ...
                                  .where((element) =>
                              element.category ==
                                  postCreateController!.selectCategoryId.value)
                                  .length,
                              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                crossAxisCount: 4,
                                mainAxisSpacing: 11.0,
                              ...
                              itemBuilder: (context, index) {
                                return InkWell(
                                  onTap: () {
                                    postCreateController!.patOriginUpdate(
                                        postCreateController!.originList!.value
                                            .where((element) =>
                                        element.category ==
                                            postCreateController!
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        element.category ==
                                            postCreateController!
                                                .selectCategoryId.value)
                                            .toList()[index].originName!
                                            .length > 5
                                            ? postCreateController!.originList!
                                            .value.where((element) =>
                                        element.category ==
                                            postCreateController!
                                                .selectCategoryId.value)
                        ...
                        child: Padding(
                          ...
                          child: GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return InkWell(
                                  onTap: () {
                                    postCreateController!.patCatergoryUpdate(
                                        categoryList[index]);
                                    Navigator.pop(context);
                                  },
                                  child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: CustomButton(
                                    ...
                                    title: "Apply",
                                    onTap: () {
                                      postCreateController!.patAgeUpdate(
                                          _currentValue, _currentValue2);
                                      Navigator.pop(context);
                                    }),
                              ),
                            ],
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  SvgPicture.asset("assets/icons/border.svg"),
                                  SizedBox(width: 12.w,),
                                  Text("Weight", style: semiBoldText(
                                      20.sp, color: appBarTitleTextColor),)
                                ],
                              ),
                            ),
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: CustomButton(
                                    ...
                                    title: "Apply",
                                    onTap: () {
                                      postCreateController!.patWeightUpdate(
                                          _currentValue, _currentValue2);
                                      Navigator.pop(context);
                                    }),
                              ),
